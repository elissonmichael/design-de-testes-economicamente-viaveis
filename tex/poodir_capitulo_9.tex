...
Esses primeiros testes usam código de exemplos do Capítulo 3, Lidando com Dependências. A seguir é apresentado o código para te lembrar das classes Roda e Engrenagem, uma vez que elas estão juntas. Engrenagem cria uma instância da classe Roda dentro do método polegadas, na linha 24 abaixo.
...
\begin{figure}[!htbp]
  \center
  \includegraphics[scale=0.40]{imagens/codigo_pag_201.png}
